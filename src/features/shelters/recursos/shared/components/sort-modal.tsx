...
import { X, Calendar, Hash, ArrowUp, ArrowDown } from 'lucide-preact';

export type SortField = 'data' | 'quantidade';
...
export const SortModal = ({ isOpen, onClose, currentConfig, onApply }: SortModalProps) => {
  const [field, setField] = useState<SortField>(currentConfig.field);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-[400px] p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-bold text-[#0a0a0a]">Ordenar Tabela</h2>
          <button
            onClick={onClose}
