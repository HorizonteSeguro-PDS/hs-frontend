...
interface EntryResourceModalProps {
  open: boolean
  onClose: () => void
  onSubmit: (data: ResourceEntryFormData) => void
}

interface ResourceEntryFormData {
  category: string
  resource: string
  quantity: string
}

const initialFormData: ResourceEntryFormData = {
  category: '',
  resource: '',
  quantity: '',
}
...
export default function EntryResourceModal({ open, onClose, onSubmit }: EntryResourceModalProps) {
  const [formData, setFormData] = useState<ResourceEntryFormData>(initialFormData)

  if (!open) return null

  function updateField<K extends keyof ResourceEntryFormData>(field: K, value: ResourceEntryFormData[K]) {
...
function EntryIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path
        d="M10.6938 21.1262C10.9894 21.2969 11.3247 21.3867 11.666 21.3867C12.0073 21.3867 12.3426 21.2969 12.6382 21.1262L19.4438 17.2373C19.7391 17.0669 19.9844 16.8217 20.155 16.5265C20.3257 16.2313 20.4157 15.8964 20.416 15.5554V7.77763C20.4157 7.43664 20.3257 7.10175 20.155 6.80654C19.9844 6.51132 19.7391 6.26618 19.4438 6.09568L12.6382 2.2068C12.3426 2.03613 12.0073 1.94629 11.666 1.94629C11.3247 1.94629 10.9894 2.03613 10.6938 2.2068L3.88824 6.09568C3.59294 6.26618 3.34766 6.51132 3.17702 6.80654C3.00638 7.10175 2.91637 7.43664 2.91602 7.77763V15.5554C2.91637 15.8964 3.00638 16.2313 3.17702 16.5265C3.34766 16.8217 3.59294 17.0669 3.88824 17.2373L10.6938 21.1262Z"
        stroke="white"
        strokeWidth="1.94444"
        strokeLinecap="round"
